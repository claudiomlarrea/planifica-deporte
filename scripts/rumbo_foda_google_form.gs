/**
 * Rumbo — completar preguntas del formulario FODA / DAFO
 *
...
function buildRumboFodaForm() {
  ...
  form.setConfirmationMessage(
    "¡Gracias! Tu aporte ayuda a construir el PEI. La comisión revisará las respuestas en Rumbo."
  );
  ...
  Logger.log("Formulario Rumbo FODA actualizado: " + form.getEditUrl());
}
